...
class BeamSearchDecoder(object):
  ...
  def decode(self):
    ...
    while True:
      ...
      article_list.append(article_withunks)
      summ_list.append(decoded_output)
      pickle.dump(article_list,open("articles.pkl","wb"))
      pickle.dump(summ_list,open("summs.pkl","wb"))
